# QWEN.md: Qwen Code Guidelines

This file provides guidance on how to interact with Qwen Code in this repository. It contains both the interaction protocol (the AI Team) and the technical architecture for the project.
...
6.  **AUTONOMOUS MODE:** After completing the work for one role, you will immediately start the next turn by adopting the next role, continuing until the task is complete.
